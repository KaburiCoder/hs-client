...
const schema = Joi.object<State>({
  ...
  n2_1: Joi.string().valid("1", "2", "3", "4", "5").required(),
  n2_2: Joi.string().valid("1", "2", "3", "4", "5").required(),
  n3: Joi.string().valid("1", "2", "3", "4", "5").required(),
  n4: Joi.string().valid("1", "2", "3", "4", "5").required(),
  n5: Joi.string().valid("1", "2", "3", "4", "5").required(),
  n6: Joi.string().valid("1", "2", "3", "4", "5").required(),
  n7: Joi.string().valid("1", "2", "3", "4", "5").required(),
  n8: Joi.string().valid("1", "2", "3", "4", "5").required(),
